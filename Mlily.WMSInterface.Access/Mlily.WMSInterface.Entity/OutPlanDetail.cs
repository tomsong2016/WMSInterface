...
{
	[SugarTable("OutPlanDetail")]
    public class OutPlanDetail 
    {
		...
		///  
		/// </summary>
		public Guid? OutPlanMain { get; set; }  

		/// <summary>
		///  
		/// </summary>
		public Guid? OutOrderDetail { get; set; }  
		...
		///  
		/// </summary>
		public decimal? PreAllotQuantity { get; set; }  
		...
		///  
		/// </summary>
		public decimal? BoxQuantityAllot { get; set; }  
		...
		///  
		/// </summary>
		public Guid? BillStatus { get; set; }  
