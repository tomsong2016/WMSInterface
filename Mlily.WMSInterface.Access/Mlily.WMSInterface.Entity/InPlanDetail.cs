...
{
	[SugarTable("InPlanDetail")]
    public class InPlanDetail 
    {
		...
		///  
		/// </summary>
		public Guid? InPlanMain { get; set; }  
		...
		///  
		/// </summary>
		public bool? ReceivingUnlimited { get; set; }  
		...
		///  
		/// </summary>
		public bool? ReceivingCompleted { get; set; }  
